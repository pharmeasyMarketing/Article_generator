...
@st.cache_data(show_spinner=False)
def generate_sections(improved_outline, word_count model="gpt-3.5-turbo", max_tokens=word_count):
    sections = []
...
def generate_article(topic, model="gpt-3.5-turbo", max_tokens_outline=2000, max_tokens_section=2000, max_tokens_improve_section=word_count):
    status = st.empty()
