...
@st.cache_data(show_spinner=False)
def generate_outline(topic, model="gpt-3.5-turbo", max_tokens):
...
@st.cache_data(show_spinner=False)
def improve_outline(outline, semantic_readout, model="gpt-3.5-turbo", max_tokens):
...
def generate_article(topic,word_count, model="gpt-3.5-turbo", max_tokens_outline=2000, max_tokens_section=2000, max_tokens_improve_section=4000):
    ...
    initial_outline = generate_outline(topic, model=model, max_tokens=int(word_count*0.60))

    status.text('Improving the initial outline...')
    improved_outline = improve_outline(initial_outline, semantic_readout, model=model, max_tokens=int(word_count*0.60))
